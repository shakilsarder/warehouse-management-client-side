...
const SingleInventory = () => {
    ...
    useEffect(() => {
        const url = `https://infinite-bayou-96668.herokuapp.com/product/${id}`;
        fetch(url)
            .then(res => res.json())
    ...
    const handleDelivered = () => {
        ...
        fetch(`https://infinite-bayou-96668.herokuapp.com/product/${id}/delivered`, {
            method: 'PUT',
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleRestock = (e) => {
        ...
        fetch(`https://infinite-bayou-96668.herokuapp.com/product/${id}/restock`, {
            method: 'PUT',
